...
- **A — Persistent boundary:** concise startup output and a permanent warning strip keep the risk visible without taking over the application.
...
- [A — Persistent boundary, current Development Host](screenshots/A-current.png)
