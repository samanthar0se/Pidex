...
| `FX-INT-04`–`07` | Interaction decision | Resolve; pending, competing Device, deadline, withdrawal, Stop, privacy | Variant B competing-Device simulation; non-visual privacy rule | All | Pidex exact Interaction model | Pending row focus, next-request focus, exact target/result/next action recognizable | Verified | [Shared delivery evidence](#shared-delivery-evidence) |
